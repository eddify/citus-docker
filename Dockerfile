...
# build and install cstore_fdw and cartodb extensions
RUN apt-get update \
    ...
    && git clone https://github.com/CartoDB/cartodb-postgresql /opt/cartodb-postgresql \
    && cd /opt/cartodb-postgresql && make && make install \
...
COPY 000-symlink-workerlist.sh 001-create-citus-extension.sql 002-create-cstore_fdw-extension.sql 003-create-postgis-extension.sql 004-create-cartodb-extension.sql /docker-entrypoint-initdb.d/
